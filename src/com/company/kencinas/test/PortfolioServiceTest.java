...
import com.company.kencinas.bank.service.impl.PortfolioServiceOperations;
import com.company.kencinas.bank.util.cash.Currency;
import com.company.kencinas.bank.util.cash.CurrencyConverter;
...
import static com.company.kencinas.bank.util.instrument.PricingExternalService.EUR_BOND_PRICE;
import static com.company.kencinas.bank.util.instrument.PricingExternalService.EUR_STOCK_PRICE;
...
public class PortfolioServiceTest extends BaseTest {
    ...
    private void testBuyEurosSuccess() {
        ...
        assert Objects.nonNull(portfolio);
        assert !portfolio.getInstruments().isEmpty();
        assert portfolio.getInstruments().stream()
                .anyMatch(instrument -> InvestType.CASH_EUR.equals(instrument.getType()));
